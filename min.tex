...
Cenou za rozšíření této struktrury o další odkaz je snížení maximálního množství dostupných struktur o čtvrtinu a zhoršení přenositelnosti kódu na jiný mikrokontroler s jiným typem ETHERNET periferie.
...
Funkcionalita implementace byla v průběhu vývoje často testována obecnými předpřipravenými testy z projektu RTEMS.
